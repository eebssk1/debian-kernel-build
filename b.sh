...
if [ x$2 = xgcc ]; then
KCFLAGS="-fgraphite -fgraphite-identity -fipa-pta -fmodulo-sched -fmodulo-sched-allow-regmoves -freschedule-modulo-scheduled-loops -flive-range-shrinkage -floop-nest-optimize -fsched-pressure -fsched-spec-load -fsched-stalled-insns=4 -fsched-stalled-insns-dep=6 -fschedule-insns -ftree-lrs -ftree-cselim -fweb -fira-region=all -fgcse-sm -fgcse-las -malign-data=cacheline -mrelax-cmpxchg-loop @$PWD/../gp.txt"
else
