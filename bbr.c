 ...
 */
static const int bbr_high_gain  = BBR_UNIT * 2925 / 1000 + 1;
/* The pacing gain of 1/high_gain in BBR_DRAIN is calculated to typically drain
 * the queue created in BBR_STARTUP in a single round:
 */
static const int bbr_drain_gain = BBR_UNIT * 1000 / 2827;
/* The gain for deriving steady-state cwnd tolerates delayed/stretched ACKs: */
static const int bbr_cwnd_gain  = BBR_UNIT * 2 + BBR_UNIT * 46 / 50;
/* The pacing_gain values for the PROBE_BW gain cycle, to discover/share bw: */
static const int bbr_pacing_gain[] = {
	BBR_UNIT * 99 / 50,	/* probe for more available bw */
	BBR_UNIT * 39 / 50,	/* drain queue and/or yield bw to other flows */
	BBR_UNIT * 28 / 25, BBR_UNIT * 27 / 25, BBR_UNIT * 29 / 25,	/* cruise at 1.0*bw to utilize pipe, */
	BBR_UNIT * 59 / 50, BBR_UNIT * 58 / 50, BBR_UNIT * 60 / 50	/* without creating excess queue... */
};
...
static const u32 bbr_lt_loss_thresh = 65;
...
static const u32 bbr_extra_acked_max_us = 104 * 1000;
